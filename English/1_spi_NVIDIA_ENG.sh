...
then
	...
	apt-get install -y asunder audacious audacity bleachbit calibre comix converseen dosbox fbreader gimp gimp-plugin-registry gimp-gmic gimp-ufraw inkscape python-gobject ufw gufw geany pyroom stellarium synaptic vlc
